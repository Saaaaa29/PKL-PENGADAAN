...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 21 Mar 2026 pada 13.27
...
CREATE TABLE `notifikasi` (
  `id` int(11) NOT NULL,
  `untuk_role` varchar(50) NOT NULL DEFAULT 'manajer_pengadaan',
  `untuk_user_id` int(11) DEFAULT NULL,
  `tipe` varchar(50) NOT NULL,
  `pesan` text NOT NULL,
  `realisasi_id` int(11) NOT NULL,
  `dari_user_id` int(11) DEFAULT NULL,
  `dibaca` tinyint(4) NOT NULL DEFAULT 0,
  `dibaca_oleh` text DEFAULT NULL,
...
(238, 149, NULL, 'Kertas HVS A4 80gr', 10.00, 'rim', 45000.00, 450000.00, 'barang', ''),
(239, 149, NULL, 'Tinta Printer Canon Black', 8.00, 'botol', 85000.00, 680000.00, 'barang', ''),
(240, 149, NULL, 'Ballpoint, Stapler, Gunting', 1.00, 'paket', 3370000.00, 3370000.00, 'barang', 'Paket lengkap ATK'),
(241, 150, NULL, 'Servis & Freon AC 2 PK (5 unit)', 5.00, 'unit', 1750000.00, 8750000.00, '', 'Termasuk cuci dan isi freon'),
(242, 151, NULL, 'Laptop Core i5 Gen 12 RAM 16GB', 3.00, 'unit', 9500000.00, 28500000.00, 'barang', 'Merk Lenovo IdeaPad'),
(243, 151, NULL, 'Mouse Wireless + Tas Laptop', 3.00, 'paket', 500000.00, 1500000.00, 'barang', ''),
(244, 151, NULL, 'Instalasi & Konfigurasi', 1.00, 'ls', 2000000.00, 2000000.00, '', ''),
(245, 152, NULL, 'Cat Tembok Exterior (20 liter)', 30.00, 'kaleng', 450000.00, 13500000.00, 'barang', 'Merk Dulux WeatherShield'),
(246, 152, NULL, 'Cat Tembok Interior (20 liter)', 20.00, 'kaleng', 380000.00, 7600000.00, 'barang', 'Merk Nippon Paint'),
(247, 152, NULL, 'Jasa Pengecatan Gedung 3 Lantai', 1.00, 'ls', 26400000.00, 26400000.00, '', 'Termasuk material bantu'),
(248, 153, NULL, 'Kamera CCTV IP 4MP Outdoor', 24.00, 'unit', 2500000.00, 60000000.00, 'barang', 'Hikvision DS-2CD'),
(249, 153, NULL, 'Kamera CCTV IP 4MP Indoor', 8.00, 'unit', 1800000.00, 14400000.00, 'barang', ''),
(250, 153, NULL, 'NVR 32 Channel + HDD 8TB', 1.00, 'unit', 45000000.00, 45000000.00, 'barang', 'Termasuk instalasi kabel'),
(251, 153, NULL, 'Jasa Instalasi & Konfigurasi', 1.00, 'ls', 65600000.00, 65600000.00, '', ''),
(252, 154, NULL, 'Kabel Fiber Optic SM 8 Core', 500.00, 'm', 120000.00, 60000000.00, 'barang', 'Termasuk accessories'),
(253, 154, NULL, 'Switch Manageable 24 Port', 4.00, 'unit', 12500000.00, 50000000.00, 'barang', ''),
(254, 154, NULL, 'Jasa Instalasi Jaringan', 1.00, 'ls', 210000000.00, 210000000.00, '', 'Termasuk testing & commissioning'),
(255, 155, NULL, 'Genset Silent 100 KVA', 1.00, 'unit', 520000000.00, 520000000.00, 'barang', 'Merk Perkins / setara'),
(256, 155, NULL, 'Jasa Instalasi & Panel ATS', 1.00, 'ls', 60000000.00, 60000000.00, '', ''),
(257, 156, NULL, 'Pekerjaan Sipil & Arsitektur', 1.00, 'ls', 550000000.00, 550000000.00, '', 'Termasuk partisi dan plafon'),
(258, 156, NULL, 'Pekerjaan Mekanikal & Elektrikal', 1.00, 'ls', 280000000.00, 280000000.00, '', ''),
(259, 156, NULL, 'Pengadaan Furniture Lab', 1.00, 'ls', 120000000.00, 120000000.00, 'barang', 'Meja, kursi, lemari reagen'),
(260, 157, NULL, 'Kendaraan Roda 4 Pick Up 1.5L', 3.00, 'unit', 250000000.00, 750000000.00, 'barang', 'Merk Mitsubishi L300 / setara'),
(261, 157, NULL, 'BBN & Balik Nama', 3.00, 'unit', 50000000.00, 150000000.00, '', 'Termasuk asuransi 1 tahun'),
(262, 157, NULL, 'Aksesoris Kendaraan', 3.00, 'paket', 116666.67, 350000.00, 'barang', 'Karpet, kaca film'),
(266, 149, NULL, 'Kertas HVS A4 80gr', 10.00, 'rim', 45000.00, 450000.00, 'barang', ''),
(267, 149, NULL, 'Tinta Printer Canon Black', 8.00, 'botol', 85000.00, 680000.00, 'barang', ''),
(268, 149, NULL, 'Ballpoint, Stapler, Gunting', 1.00, 'paket', 3370000.00, 3370000.00, 'barang', 'Paket lengkap ATK'),
(269, 150, NULL, 'Servis & Freon AC 2 PK (5 unit)', 5.00, 'unit', 1750000.00, 8750000.00, '', 'Termasuk cuci dan isi freon'),
(270, 151, NULL, 'Laptop Core i5 Gen 12 RAM 16GB', 3.00, 'unit', 9500000.00, 28500000.00, 'barang', 'Merk Lenovo IdeaPad'),
(271, 151, NULL, 'Mouse Wireless + Tas Laptop', 3.00, 'paket', 500000.00, 1500000.00, 'barang', ''),
(272, 151, NULL, 'Instalasi & Konfigurasi', 1.00, 'ls', 2000000.00, 2000000.00, '', ''),
(273, 152, NULL, 'Cat Tembok Exterior (20 liter)', 30.00, 'kaleng', 450000.00, 13500000.00, 'barang', 'Merk Dulux WeatherShield'),
(274, 152, NULL, 'Cat Tembok Interior (20 liter)', 20.00, 'kaleng', 380000.00, 7600000.00, 'barang', 'Merk Nippon Paint'),
(275, 152, NULL, 'Jasa Pengecatan Gedung 3 Lantai', 1.00, 'ls', 26400000.00, 26400000.00, '', 'Termasuk material bantu'),
(276, 153, NULL, 'Kamera CCTV IP 4MP Outdoor', 24.00, 'unit', 2500000.00, 60000000.00, 'barang', 'Hikvision DS-2CD'),
(277, 153, NULL, 'Kamera CCTV IP 4MP Indoor', 8.00, 'unit', 1800000.00, 14400000.00, 'barang', ''),
(278, 153, NULL, 'NVR 32 Channel + HDD 8TB', 1.00, 'unit', 45000000.00, 45000000.00, 'barang', 'Termasuk instalasi kabel'),
(279, 153, NULL, 'Jasa Instalasi & Konfigurasi', 1.00, 'ls', 65600000.00, 65600000.00, '', ''),
(280, 154, NULL, 'Kabel Fiber Optic SM 8 Core', 500.00, 'm', 120000.00, 60000000.00, 'barang', 'Termasuk accessories'),
(281, 154, NULL, 'Switch Manageable 24 Port', 4.00, 'unit', 12500000.00, 50000000.00, 'barang', ''),
(282, 154, NULL, 'Jasa Instalasi Jaringan', 1.00, 'ls', 210000000.00, 210000000.00, '', 'Termasuk testing & commissioning'),
(283, 155, NULL, 'Genset Silent 100 KVA', 1.00, 'unit', 520000000.00, 520000000.00, 'barang', 'Merk Perkins / setara'),
(284, 155, NULL, 'Jasa Instalasi & Panel ATS', 1.00, 'ls', 60000000.00, 60000000.00, '', ''),
(285, 156, NULL, 'Pekerjaan Sipil & Arsitektur', 1.00, 'ls', 550000000.00, 550000000.00, '', 'Termasuk partisi dan plafon'),
(286, 156, NULL, 'Pekerjaan Mekanikal & Elektrikal', 1.00, 'ls', 280000000.00, 280000000.00, '', ''),
(287, 156, NULL, 'Pengadaan Furniture Lab', 1.00, 'ls', 120000000.00, 120000000.00, 'barang', 'Meja, kursi, lemari reagen'),
(288, 157, NULL, 'Kendaraan Roda 4 Pick Up 1.5L', 3.00, 'unit', 250000000.00, 750000000.00, 'barang', 'Merk Mitsubishi L300 / setara'),
(289, 157, NULL, 'BBN & Balik Nama', 3.00, 'unit', 50000000.00, 150000000.00, '', 'Termasuk asuransi 1 tahun'),
(290, 157, NULL, 'Aksesoris Kendaraan', 3.00, 'paket', 116666.67, 350000.00, 'barang', 'Karpet, kaca film'),
(294, 149, NULL, 'Kertas HVS A4 80gr', 10.00, 'rim', 45000.00, 450000.00, 'barang', ''),
(295, 149, NULL, 'Tinta Printer Canon Black', 8.00, 'botol', 85000.00, 680000.00, 'barang', ''),
(296, 149, NULL, 'Ballpoint, Stapler, Gunting', 1.00, 'paket', 3370000.00, 3370000.00, 'barang', 'Paket lengkap ATK'),
(297, 150, NULL, 'Servis & Freon AC 2 PK (5 unit)', 5.00, 'unit', 1750000.00, 8750000.00, '', 'Termasuk cuci dan isi freon'),
(298, 151, NULL, 'Laptop Core i5 Gen 12 RAM 16GB', 3.00, 'unit', 9500000.00, 28500000.00, 'barang', 'Merk Lenovo IdeaPad'),
(299, 151, NULL, 'Mouse Wireless + Tas Laptop', 3.00, 'paket', 500000.00, 1500000.00, 'barang', ''),
(300, 151, NULL, 'Instalasi & Konfigurasi', 1.00, 'ls', 2000000.00, 2000000.00, '', ''),
(301, 152, NULL, 'Cat Tembok Exterior (20 liter)', 30.00, 'kaleng', 450000.00, 13500000.00, 'barang', 'Merk Dulux WeatherShield'),
(302, 152, NULL, 'Cat Tembok Interior (20 liter)', 20.00, 'kaleng', 380000.00, 7600000.00, 'barang', 'Merk Nippon Paint'),
(303, 152, NULL, 'Jasa Pengecatan Gedung 3 Lantai', 1.00, 'ls', 26400000.00, 26400000.00, '', 'Termasuk material bantu'),
(304, 153, NULL, 'Kamera CCTV IP 4MP Outdoor', 24.00, 'unit', 2500000.00, 60000000.00, 'barang', 'Hikvision DS-2CD'),
(305, 153, NULL, 'Kamera CCTV IP 4MP Indoor', 8.00, 'unit', 1800000.00, 14400000.00, 'barang', ''),
(306, 153, NULL, 'NVR 32 Channel + HDD 8TB', 1.00, 'unit', 45000000.00, 45000000.00, 'barang', 'Termasuk instalasi kabel'),
(307, 153, NULL, 'Jasa Instalasi & Konfigurasi', 1.00, 'ls', 65600000.00, 65600000.00, '', ''),
(308, 154, NULL, 'Kabel Fiber Optic SM 8 Core', 500.00, 'm', 120000.00, 60000000.00, 'barang', 'Termasuk accessories'),
(309, 154, NULL, 'Switch Manageable 24 Port', 4.00, 'unit', 12500000.00, 50000000.00, 'barang', ''),
(310, 154, NULL, 'Jasa Instalasi Jaringan', 1.00, 'ls', 210000000.00, 210000000.00, '', 'Termasuk testing & commissioning'),
(311, 155, NULL, 'Genset Silent 100 KVA', 1.00, 'unit', 520000000.00, 520000000.00, 'barang', 'Merk Perkins / setara'),
(312, 155, NULL, 'Jasa Instalasi & Panel ATS', 1.00, 'ls', 60000000.00, 60000000.00, '', ''),
(313, 156, NULL, 'Pekerjaan Sipil & Arsitektur', 1.00, 'ls', 550000000.00, 550000000.00, '', 'Termasuk partisi dan plafon'),
(314, 156, NULL, 'Pekerjaan Mekanikal & Elektrikal', 1.00, 'ls', 280000000.00, 280000000.00, '', ''),
(315, 156, NULL, 'Pengadaan Furniture Lab', 1.00, 'ls', 120000000.00, 120000000.00, 'barang', 'Meja, kursi, lemari reagen'),
(316, 157, NULL, 'Kendaraan Roda 4 Pick Up 1.5L', 3.00, 'unit', 250000000.00, 750000000.00, 'barang', 'Merk Mitsubishi L300 / setara'),
(317, 157, NULL, 'BBN & Balik Nama', 3.00, 'unit', 50000000.00, 150000000.00, '', 'Termasuk asuransi 1 tahun'),
(318, 157, NULL, 'Aksesoris Kendaraan', 3.00, 'paket', 116666.67, 350000.00, 'barang', 'Karpet, kaca film'),
(322, 149, NULL, 'Kertas HVS A4 80gr', 10.00, 'rim', 45000.00, 450000.00, 'barang', ''),
(323, 149, NULL, 'Tinta Printer Canon Black', 8.00, 'botol', 85000.00, 680000.00, 'barang', ''),
(324, 149, NULL, 'Ballpoint, Stapler, Gunting', 1.00, 'paket', 3370000.00, 3370000.00, 'barang', 'Paket lengkap ATK'),
(325, 150, NULL, 'Servis & Freon AC 2 PK (5 unit)', 5.00, 'unit', 1750000.00, 8750000.00, '', 'Termasuk cuci dan isi freon'),
(326, 151, NULL, 'Laptop Core i5 Gen 12 RAM 16GB', 3.00, 'unit', 9500000.00, 28500000.00, 'barang', 'Merk Lenovo IdeaPad'),
(327, 151, NULL, 'Mouse Wireless + Tas Laptop', 3.00, 'paket', 500000.00, 1500000.00, 'barang', ''),
(328, 151, NULL, 'Instalasi & Konfigurasi', 1.00, 'ls', 2000000.00, 2000000.00, '', ''),
(329, 152, NULL, 'Cat Tembok Exterior (20 liter)', 30.00, 'kaleng', 450000.00, 13500000.00, 'barang', 'Merk Dulux WeatherShield'),
(330, 152, NULL, 'Cat Tembok Interior (20 liter)', 20.00, 'kaleng', 380000.00, 7600000.00, 'barang', 'Merk Nippon Paint'),
(331, 152, NULL, 'Jasa Pengecatan Gedung 3 Lantai', 1.00, 'ls', 26400000.00, 26400000.00, '', 'Termasuk material bantu'),
(332, 153, NULL, 'Kamera CCTV IP 4MP Outdoor', 24.00, 'unit', 2500000.00, 60000000.00, 'barang', 'Hikvision DS-2CD'),
(333, 153, NULL, 'Kamera CCTV IP 4MP Indoor', 8.00, 'unit', 1800000.00, 14400000.00, 'barang', ''),
(334, 153, NULL, 'NVR 32 Channel + HDD 8TB', 1.00, 'unit', 45000000.00, 45000000.00, 'barang', 'Termasuk instalasi kabel'),
(335, 153, NULL, 'Jasa Instalasi & Konfigurasi', 1.00, 'ls', 65600000.00, 65600000.00, '', ''),
(336, 154, NULL, 'Kabel Fiber Optic SM 8 Core', 500.00, 'm', 120000.00, 60000000.00, 'barang', 'Termasuk accessories'),
(337, 154, NULL, 'Switch Manageable 24 Port', 4.00, 'unit', 12500000.00, 50000000.00, 'barang', ''),
(338, 154, NULL, 'Jasa Instalasi Jaringan', 1.00, 'ls', 210000000.00, 210000000.00, '', 'Termasuk testing & commissioning'),
(339, 155, NULL, 'Genset Silent 100 KVA', 1.00, 'unit', 520000000.00, 520000000.00, 'barang', 'Merk Perkins / setara'),
(340, 155, NULL, 'Jasa Instalasi & Panel ATS', 1.00, 'ls', 60000000.00, 60000000.00, '', ''),
(341, 156, NULL, 'Pekerjaan Sipil & Arsitektur', 1.00, 'ls', 550000000.00, 550000000.00, '', 'Termasuk partisi dan plafon'),
(342, 156, NULL, 'Pekerjaan Mekanikal & Elektrikal', 1.00, 'ls', 280000000.00, 280000000.00, '', ''),
(343, 156, NULL, 'Pengadaan Furniture Lab', 1.00, 'ls', 120000000.00, 120000000.00, 'barang', 'Meja, kursi, lemari reagen'),
(344, 157, NULL, 'Kendaraan Roda 4 Pick Up 1.5L', 3.00, 'unit', 250000000.00, 750000000.00, 'barang', 'Merk Mitsubishi L300 / setara'),
(345, 157, NULL, 'BBN & Balik Nama', 3.00, 'unit', 50000000.00, 150000000.00, '', 'Termasuk asuransi 1 tahun'),
(346, 157, NULL, 'Aksesoris Kendaraan', 3.00, 'paket', 116666.67, 350000.00, 'barang', 'Karpet, kaca film'),
(350, 158, NULL, 'Tanaman Hias & Pohon Peneduh', 1.00, 'ls', 25000000.00, 25000000.00, 'barang', ''),
(351, 158, NULL, 'Material Taman (paving, batu)', 1.00, 'ls', 30000000.00, 30000000.00, 'barang', ''),
(352, 158, NULL, 'Jasa Penataan & Pemasangan', 1.00, 'ls', 20000000.00, 20000000.00, 'jasa_lainnya', ''),
(353, 158, NULL, 'Tanaman Hias & Pohon Peneduh', 1.00, 'ls', 25000000.00, 25000000.00, 'barang', ''),
(354, 158, NULL, 'Material Taman (paving, batu)', 1.00, 'ls', 30000000.00, 30000000.00, 'barang', ''),
(355, 158, NULL, 'Jasa Penataan & Pemasangan', 1.00, 'ls', 20000000.00, 20000000.00, 'jasa_lainnya', ''),
(356, 158, NULL, 'Tanaman Hias & Pohon Peneduh', 1.00, 'ls', 25000000.00, 25000000.00, 'barang', ''),
(357, 158, NULL, 'Material Taman (paving, batu)', 1.00, 'ls', 30000000.00, 30000000.00, 'barang', ''),
(358, 158, NULL, 'Jasa Penataan & Pemasangan', 1.00, 'ls', 20000000.00, 20000000.00, 'jasa_lainnya', ''),
(359, 158, NULL, 'Tanaman Hias & Pohon Peneduh', 1.00, 'ls', 25000000.00, 25000000.00, 'barang', ''),
(360, 158, NULL, 'Material Taman (paving, batu)', 1.00, 'ls', 30000000.00, 30000000.00, 'barang', ''),
(361, 158, NULL, 'Jasa Penataan & Pemasangan', 1.00, 'ls', 20000000.00, 20000000.00, 'jasa_lainnya', '');
...
INSERT INTO `realisasi_kegiatan` (`id`, `nomor_kontrak`, `tanggal_mulai`, `tanggal_selesai`, `status`, `status_verifikasi`, `catatan_verifikasi`, `diverifikasi_oleh`, `tgl_verifikasi`, `total_nilai`, `metode_pengadaan`, `catatan`, `created_by`, `created_at`, `updated_at`) VALUES
(11, 'NO 1 RAB', '2025-06-26', '2025-06-30', 'selesai', 'disetujui', NULL, NULL, NULL, 39696000.00, 'tender_terbatas_spk', '', 1, '2026-02-26 00:27:30', '2026-03-06 06:46:28'),
(12, 'NO 2 RAB', '2025-07-20', '2025-08-26', 'selesai', 'disetujui', NULL, NULL, NULL, 69534000.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 00:30:25', '2026-03-06 06:46:28'),
(13, 'NO 3 RAB', '2025-09-26', '2025-10-26', 'selesai', 'disetujui', NULL, NULL, NULL, 110832000.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 00:32:03', '2026-03-06 06:46:28'),
(14, 'NO 1 KONS', '2025-01-26', '2025-02-26', 'selesai', 'disetujui', NULL, NULL, NULL, 297060000.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 00:39:11', '2026-03-06 06:46:28'),
(15, '300.XX/PB/AMGM/2025', '2025-09-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 522426000.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 00:40:57', '2026-03-06 06:46:28'),
(16, '300.XX/PB/AMGM/2025', '2025-09-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 522426000.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 00:42:16', '2026-03-06 06:46:28'),
(17, '300.XX/PB/AMGM/2025', '2025-08-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 355305000.00, 'tender_terbatas_pkp', '3 Kegiatan Rencana dijadikan satu', 1, '2026-02-26 00:48:27', '2026-03-06 06:46:28'),
(18, '300.XX/PB/AMGM/2025', '2025-11-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 127120000.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 00:52:53', '2026-03-06 06:46:28'),
(19, '300.XX/PB/AMGM/2025', '2025-11-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 83100000.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 06:09:49', '2026-03-06 06:46:28'),
(20, 'NO 4 RAB', '2025-07-26', '2025-08-26', 'selesai', 'disetujui', NULL, NULL, NULL, 181663000.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 06:11:27', '2026-03-06 06:46:28'),
(21, 'NO 5 RAB', '2025-09-26', '2025-10-26', 'selesai', 'disetujui', NULL, NULL, NULL, 32838000.00, 'tender_terbatas_spk', '', 1, '2026-02-26 06:13:07', '2026-03-06 06:46:28'),
(22, 'NO 6 RAB', '2025-02-26', '2025-03-26', 'selesai', 'disetujui', NULL, NULL, NULL, 102129000.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 06:16:50', '2026-03-06 06:46:28'),
(23, '300.XX/PB/AMGM/2025', '2025-05-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 69176000.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 06:18:05', '2026-03-06 06:46:28'),
(24, '300.XX/PB/AMGM/2025', '2025-07-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 214224260.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 07:32:48', '2026-03-06 06:46:28'),
(25, '300.XX/PB/AMGM/2025', '2025-08-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 329095000.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 09:56:06', '2026-03-06 06:46:28'),
(26, '300.XX/PB/AMGM/2025', '2025-08-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 203895000.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 09:57:13', '2026-03-06 06:46:28'),
(27, '300.XX/PB/AMGM/2025', '2025-08-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 42000000.00, 'tender_terbatas_spk', '', 1, '2026-02-26 09:58:14', '2026-03-06 06:46:28'),
(28, '300.XX/PB/AMGM/2025', '2025-03-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 500980000.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 10:32:01', '2026-03-06 06:46:28'),
(29, '300.XX/PB/AMGM/2025', '2025-06-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 408772000.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 10:33:47', '2026-03-06 06:46:28'),
(30, '300.XX/PB/AMGM/2025', '2025-10-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 14625000.00, 'pembelian_langsung', '', 1, '2026-02-26 11:26:17', '2026-03-06 06:46:28'),
(31, '300.XX/PB/AMGM/2025', '2025-11-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 14625000.00, 'pembelian_langsung', '', 1, '2026-02-26 11:26:53', '2026-03-06 06:46:28'),
(32, '300.XX/PB/AMGM/2025', '2025-11-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 51350000.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 11:28:01', '2026-03-06 06:46:28'),
(33, 'NO 7 RAB', '2025-02-26', '2025-03-26', 'selesai', 'disetujui', NULL, NULL, NULL, 69467000.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 11:29:30', '2026-03-06 06:46:28'),
(34, 'NO 8 RAB', '2025-06-26', '2025-07-26', 'selesai', 'disetujui', NULL, NULL, NULL, 100000000.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 11:32:18', '2026-03-06 06:46:28'),
(35, 'NO 9 RAB', '2025-10-26', '2025-11-26', 'selesai', 'disetujui', NULL, NULL, NULL, 34261000.00, 'tender_terbatas_spk', '', 1, '2026-02-26 11:33:39', '2026-03-06 06:46:28'),
(36, '300.XX/PB/AMGM/2025', '2025-04-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 260000000.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 11:34:43', '2026-03-06 06:46:28'),
(37, 'NO 10 RAB', '2025-03-26', '2025-04-26', 'selesai', 'disetujui', NULL, NULL, NULL, 120000000.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 11:36:24', '2026-03-06 06:46:28'),
(38, 'NO 11 RAB', '2025-02-26', '2025-04-26', 'selesai', 'disetujui', NULL, NULL, NULL, 18700000.00, 'tender_terbatas_spk', '', 1, '2026-02-26 13:23:44', '2026-03-06 06:46:28'),
(39, 'NO 12 RAB', '2025-11-26', '2025-12-26', 'selesai', 'disetujui', NULL, NULL, NULL, 236823000.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 13:25:47', '2026-03-06 06:46:28'),
(40, '300.XX/PB/AMGM/2025', '2025-02-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 525368000.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 13:36:58', '2026-03-06 06:46:28'),
(41, '300.XX/PB/AMGM/2025', '2025-05-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 8270000.00, 'pembelian_langsung', '', 1, '2026-02-26 13:39:13', '2026-03-06 06:46:28'),
(42, '300.XX/PB/AMGM/2025', '2025-09-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 31211000.00, 'tender_terbatas_spk', '', 1, '2026-02-26 13:40:35', '2026-03-06 06:46:28'),
(43, '300.XX/PB/AMGM/2025', '2025-03-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 15000000.00, 'pembelian_langsung', '', 1, '2026-02-26 13:51:33', '2026-03-06 06:46:28'),
(44, '300.XX/PB/AMGM/2025', '2025-09-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 13768000.00, 'pembelian_langsung', '', 1, '2026-02-26 14:04:40', '2026-03-06 06:46:28'),
(45, '300.XX/PB/AMGM/2025', '2025-07-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 16000000.00, 'tender_terbatas_spk', '', 1, '2026-02-26 14:12:23', '2026-03-06 06:46:28'),
(46, '300.XX/PB/AMGM/2025', '2025-04-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 23500000.00, 'tender_terbatas_spk', '', 1, '2026-02-26 14:16:28', '2026-03-06 06:46:28'),
(47, '300.XX/PB/AMGM/2025', '2025-01-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 9115000.00, 'pembelian_langsung', '', 1, '2026-02-26 14:19:49', '2026-03-06 06:46:28'),
(48, '300.XX/PB/AMGM/2025', '2025-05-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 9115000.00, 'pembelian_langsung', '', 1, '2026-02-26 14:21:02', '2026-03-06 06:46:28'),
(49, '300.XX/PB/AMGM/2025', '2025-03-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 9115000.00, 'pembelian_langsung', '', 1, '2026-02-26 14:22:26', '2026-03-06 06:46:28'),
(50, '300.XX/PB/AMGM/2025', '2025-08-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 9115000.00, 'pembelian_langsung', '', 1, '2026-02-26 14:29:28', '2026-03-06 06:46:28'),
(51, '300.XX/PB/AMGM/2025', '2025-01-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 14350000.00, 'pembelian_langsung', '', 1, '2026-02-26 14:31:04', '2026-03-06 06:46:28'),
(52, '300.XX/PB/AMGM/2025', '2025-03-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 13000000.00, 'pembelian_langsung', '', 1, '2026-02-26 14:33:17', '2026-03-06 06:46:28'),
(53, '300.XX/PB/AMGM/2025', '2025-03-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 14350000.00, 'pembelian_langsung', '', 1, '2026-02-26 14:35:10', '2026-03-06 06:46:28'),
(54, '300.XX/PB/AMGM/2025', '2025-03-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 13000000.00, 'pembelian_langsung', '', 1, '2026-02-26 14:39:08', '2026-03-06 06:46:28'),
(55, '300.XX/PB/AMGM/2025', '2025-03-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 5775000.00, 'pembelian_langsung', '', 1, '2026-02-26 14:40:31', '2026-03-06 06:46:28'),
(56, '300.XX/PB/AMGM/2025', '2025-03-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 13000000.00, 'pembelian_langsung', '', 1, '2026-02-26 14:41:30', '2026-03-06 06:46:28'),
(57, '300.XX/PB/AMGM/2025', '2025-01-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 7500000.00, 'pembelian_langsung', '', 1, '2026-02-26 14:42:36', '2026-03-06 06:46:28'),
(58, '300.XX/PB/AMGM/2025', '2025-09-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 7500000.00, 'pembelian_langsung', '', 1, '2026-02-26 14:43:09', '2026-03-06 06:46:28'),
(59, '300.XX/PB/AMGM/2025', '2025-09-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 7500000.00, 'pembelian_langsung', '', 1, '2026-02-26 14:43:39', '2026-03-06 06:46:28'),
(60, '300.XX/PB/AMGM/2025', '2025-04-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 13500000.00, 'pembelian_langsung', '', 1, '2026-02-26 14:45:45', '2026-03-06 06:46:28'),
(61, '300.XX/PB/AMGM/2025', '2025-08-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 13500000.00, 'pembelian_langsung', '', 1, '2026-02-26 14:46:52', '2026-03-06 06:46:28'),
(62, '300.XX/PB/AMGM/2025', '2025-09-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 4000000.00, 'pembelian_langsung', '', 1, '2026-02-26 14:47:48', '2026-03-06 06:46:28'),
(63, '300.XX/PB/AMGM/2025', '2025-08-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 350000000.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 14:48:52', '2026-03-06 06:46:28'),
(64, '300.XX/PB/AMGM/2025', '2025-10-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 520000000.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 14:50:15', '2026-03-06 06:46:28'),
(65, '300.XX/PB/AMGM/2025', '2025-11-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 577250000.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 14:53:12', '2026-03-06 06:46:28'),
(66, '300.XX/PB/AMGM/2025', '2025-11-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 300000000.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 14:54:04', '2026-03-06 06:46:28'),
(67, '300.XX/PB/AMGM/2025', '2025-06-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 237500000.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 14:54:59', '2026-03-06 06:46:28'),
(68, '300.XX/PB/AMGM/2025', '2025-04-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 117000000.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 14:56:05', '2026-03-06 06:46:28'),
(69, '300.XX/PB/AMGM/2025', '2025-10-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 150000000.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 14:57:18', '2026-03-06 06:46:28'),
(70, '300.XX/PB/AMGM/2025', '2025-11-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 16000000.00, 'tender_terbatas_spk', '', 1, '2026-02-26 14:58:32', '2026-03-06 06:46:28'),
(71, '300.XX/PB/AMGM/2025', '2025-01-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 9500000.00, 'pembelian_langsung', '', 1, '2026-02-26 14:59:50', '2026-03-06 06:46:28'),
(72, '300.XX/PB/AMGM/2025', '2025-01-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 10900000.00, 'pembelian_langsung', '', 1, '2026-02-26 15:00:47', '2026-03-06 06:46:28'),
(73, '300.XX/PB/AMGM/2025', '2025-01-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 13950000.00, 'pembelian_langsung', '', 1, '2026-02-26 15:01:54', '2026-03-06 06:46:28'),
(74, '300.XX/PB/AMGM/2025', '2025-09-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 14602000.00, 'pembelian_langsung', '', 1, '2026-02-26 15:02:30', '2026-03-06 06:46:28'),
(75, '300.XX/PB/AMGM/2025', '2025-10-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 10707000.00, 'pembelian_langsung', '', 1, '2026-02-26 15:03:29', '2026-03-06 06:46:28'),
(76, '300.XX/PB/AMGM/2025', '2025-10-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 11400000.00, 'pembelian_langsung', '', 1, '2026-02-26 15:04:38', '2026-03-06 06:46:28'),
(77, 'NO 11 RAB', '2025-05-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 180000000.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 15:05:36', '2026-03-06 06:46:28'),
(78, '300.XX/PB/AMGM/2025', '2025-01-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 4180000.00, 'pembelian_langsung', '', 1, '2026-02-26 15:06:59', '2026-03-06 06:46:28'),
(79, '300.XX/PB/AMGM/2025', '2025-05-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 8360000.00, 'pembelian_langsung', '', 1, '2026-02-26 15:07:31', '2026-03-06 06:46:28'),
(80, '300.XX/PB/AMGM/2025', '2025-02-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 8360000.00, 'pembelian_langsung', '', 1, '2026-02-26 15:44:51', '2026-03-06 06:46:28'),
(81, '300.XX/PB/AMGM/2025', '2025-03-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 6600000.00, 'pembelian_langsung', '', 1, '2026-02-26 15:45:46', '2026-03-06 06:46:28'),
(82, '300.XX/PB/AMGM/2025', '2025-05-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 6600000.00, 'pembelian_langsung', '', 1, '2026-02-26 15:46:23', '2026-03-06 06:46:28'),
(83, '300.XX/PB/AMGM/2025', '2025-09-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 4180000.00, 'pembelian_langsung', '', 1, '2026-02-26 15:47:12', '2026-03-06 06:46:28'),
(84, '300.XX/PB/AMGM/2025', '2025-09-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 4180000.00, 'pembelian_langsung', '', 1, '2026-02-26 15:47:43', '2026-03-06 06:46:28'),
(85, '300.XX/PB/AMGM/2025', '2025-02-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 3543000.00, 'pembelian_langsung', '', 1, '2026-02-26 15:48:33', '2026-03-06 06:46:28'),
(86, '300.XX/PB/AMGM/2025', '2025-10-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 7086000.00, 'pembelian_langsung', '', 1, '2026-02-26 15:49:02', '2026-03-06 06:46:28'),
(87, '300.XX/PB/AMGM/2025', '2025-02-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 3543000.00, 'pembelian_langsung', '', 1, '2026-02-26 15:49:41', '2026-03-06 06:46:28'),
(88, '300.XX/PB/AMGM/2025', '2025-05-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 3543000.00, 'pembelian_langsung', '', 1, '2026-02-26 15:50:19', '2026-03-06 06:46:28'),
(89, '300.XX/PB/AMGM/2025', '2025-05-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 7086000.00, 'pembelian_langsung', '', 1, '2026-02-26 15:51:01', '2026-03-06 06:46:28'),
(90, '300.XX/PB/AMGM/2025', '2025-09-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 14172000.00, 'pembelian_langsung', '', 1, '2026-02-26 15:51:45', '2026-03-06 06:46:28'),
(91, '300.XX/PB/AMGM/2025', '2025-09-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 10629000.00, 'pembelian_langsung', '', 1, '2026-02-26 15:56:08', '2026-03-06 06:46:28'),
(92, '300.XX/PB/AMGM/2025', '2025-02-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 13227000.00, 'pembelian_langsung', '', 1, '2026-02-26 15:56:47', '2026-03-06 06:46:28'),
(93, '300.XX/PB/AMGM/2025', '2025-02-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 8818000.00, 'pembelian_langsung', '', 1, '2026-02-26 15:57:20', '2026-03-06 06:46:28'),
(94, '300.XX/PB/AMGM/2025', '2025-09-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 8818000.00, 'pembelian_langsung', '', 1, '2026-02-26 15:57:42', '2026-03-06 06:46:28'),
(95, '300.XX/PB/AMGM/2025', '2025-02-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 11500000.00, 'pembelian_langsung', '', 1, '2026-02-26 15:58:43', '2026-03-06 06:46:28'),
(96, '300.XX/PB/AMGM/2025', '2025-03-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 3900000.00, 'pembelian_langsung', '', 1, '2026-02-26 16:01:10', '2026-03-06 06:46:28'),
(97, '300.XX/PB/AMGM/2025', '2025-04-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 3900000.00, 'pembelian_langsung', '', 1, '2026-02-26 16:01:39', '2026-03-06 06:46:28'),
(98, '300.XX/PB/AMGM/2025', '2025-03-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 3500000.00, 'pembelian_langsung', '', 1, '2026-02-26 16:02:56', '2026-03-06 06:46:28'),
(99, '300.XX/PB/AMGM/2025', '2025-02-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 410000000.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 16:04:23', '2026-03-06 06:46:28'),
(100, '300.XX/PB/AMGM/2025', '2025-03-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 50000000.00, 'tender_terbatas_spk', '', 1, '2026-02-26 16:05:38', '2026-03-06 06:46:28'),
(101, '300.XX/PB/AMGM/2025', '2025-06-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 50000000.00, 'tender_terbatas_spk', '', 1, '2026-02-26 16:06:51', '2026-03-06 06:46:28'),
(102, '300.XX/PB/AMGM/2025', '2025-02-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 55000000.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 16:07:57', '2026-03-06 06:46:28'),
(103, '300.XX/PB/AMGM/2025', '2025-03-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 55000000.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 16:08:29', '2026-03-06 06:46:28'),
(104, 'NO 2 KONS', '2025-06-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 42860000.00, 'tender_terbatas_spk', '', 1, '2026-02-26 16:10:58', '2026-03-06 06:46:28'),
(105, 'NO 3 KONS', '2025-05-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 298340000.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 16:13:24', '2026-03-06 06:46:28'),
(106, 'NO 4 KONS', '2025-05-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 245543000.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 16:14:47', '2026-03-06 06:46:28'),
(107, 'NO 5 KONS', '2025-08-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 297951000.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 16:15:52', '2026-03-06 06:46:28'),
(108, 'NO 6 KONS', '2025-06-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 233672000.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 16:17:27', '2026-03-06 06:46:28'),
(109, 'NO 7 KONS', '2025-09-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 298723000.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 16:18:57', '2026-03-06 06:46:28'),
(110, 'NO 8 KONS', '2025-09-26', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 300000000.00, 'tender_terbatas_pkp', '', 1, '2026-02-26 16:20:01', '2026-03-06 06:46:28'),
(111, '300.XX/PB/AMGM/2025', '2025-01-01', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 282102400.00, 'tender_terbatas_pkp', '', 1, '2026-03-01 08:18:31', '2026-03-06 06:46:28'),
(112, '300.XX/PB/AMGM/2025', '2025-04-01', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 282102400.00, 'tender_terbatas_pkp', '', 1, '2026-03-01 08:19:05', '2026-03-06 06:46:28'),
(113, '300.XX/PB/AMGM/2025', '2025-05-01', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 282102400.00, 'tender_terbatas_pkp', '', 1, '2026-03-01 08:19:46', '2026-03-06 06:46:28'),
(114, '300.XX/PB/AMGM/2025', '2025-06-01', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 282102400.00, 'tender_terbatas_pkp', '', 1, '2026-03-01 08:20:18', '2026-03-06 06:46:28'),
(115, '300.XX/PB/AMGM/2025', '2025-07-01', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 282102400.00, 'tender_terbatas_pkp', '', 1, '2026-03-01 08:20:40', '2026-03-06 06:46:28'),
(116, '300.XX/PB/AMGM/2025', '2025-11-01', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 282102400.00, 'tender_terbatas_pkp', '', 1, '2026-03-01 08:21:13', '2026-03-06 06:46:28'),
(117, '300.XX/PB/AMGM/2025', '2025-03-01', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 138101000.00, 'tender_terbatas_pkp', '', 1, '2026-03-01 08:23:33', '2026-03-06 06:46:28'),
(118, '300.XX/PB/AMGM/2025', '2025-04-01', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 138101000.00, 'tender_terbatas_pkp', '', 1, '2026-03-01 08:24:35', '2026-03-06 06:46:28'),
(119, '300.XX/PB/AMGM/2025', '2025-05-01', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 138101000.00, 'tender_terbatas_pkp', '', 1, '2026-03-01 08:26:03', '2026-03-06 06:46:28'),
(120, '300.XX/PB/AMGM/2025', '2025-06-01', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 138101000.00, 'tender_terbatas_pkp', '', 1, '2026-03-01 08:31:11', '2026-03-06 06:46:28'),
(121, '300.XX/PB/AMGM/2025', '2025-07-01', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 138101000.00, 'tender_terbatas_pkp', '', 1, '2026-03-01 08:32:33', '2026-03-06 06:46:28'),
(122, '300.XX/PB/AMGM/2025', '2025-08-01', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 138101000.00, 'tender_terbatas_pkp', '', 1, '2026-03-01 08:33:37', '2026-03-06 06:46:28'),
(123, '300.XX/PB/AMGM/2025', '2025-10-01', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 552404000.00, 'tender_terbatas_pkp', '', 1, '2026-03-01 08:34:41', '2026-03-06 06:46:28'),
(124, '300.XX/PB/AMGM/2025', '2025-11-01', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 138101000.00, 'tender_terbatas_pkp', '', 1, '2026-03-01 11:14:53', '2026-03-06 06:46:28'),
(125, '300.XX/PB/AMGM/2025', '2025-09-01', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 650000000.00, 'tender_umum', '', 1, '2026-03-01 13:35:52', '2026-03-06 06:46:28'),
(126, 'NO 13 RAB', '2025-03-01', '2025-04-29', 'selesai', 'disetujui', NULL, NULL, NULL, 40582000.00, 'tender_terbatas_spk', '', 1, '2026-03-01 13:36:55', '2026-03-06 06:46:28'),
(127, 'NO 14 RAB', '2025-03-01', '2025-04-01', 'selesai', 'disetujui', NULL, NULL, NULL, 36424000.00, 'tender_terbatas_spk', '', 1, '2026-03-01 13:37:40', '2026-03-06 06:46:28'),
(128, 'NO 15 RAB', '2025-03-01', '2025-04-01', 'selesai', 'disetujui', NULL, NULL, NULL, 210820000.00, 'tender_terbatas_pkp', '', 1, '2026-03-01 13:40:22', '2026-03-06 06:46:28'),
(129, 'NO 16 RAB', '2025-04-01', '2025-05-01', 'selesai', 'disetujui', NULL, NULL, NULL, 72834000.00, 'tender_terbatas_pkp', '', 1, '2026-03-01 13:46:37', '2026-03-06 06:46:28'),
(130, 'NO 18 RAB', '2025-06-01', '2025-07-01', 'selesai', 'disetujui', NULL, NULL, NULL, 56218000.00, 'tender_terbatas_pkp', '', 1, '2026-03-01 15:11:03', '2026-03-06 06:46:28'),
(131, 'NO 19 RAB', '2025-06-01', '2025-07-01', 'selesai', 'disetujui', NULL, NULL, NULL, 37298000.00, 'tender_terbatas_spk', '', 1, '2026-03-01 15:12:26', '2026-03-06 06:46:28'),
(132, 'NO 20 RAB', '2025-09-01', '2025-10-01', 'selesai', 'disetujui', NULL, NULL, NULL, 47618000.00, 'tender_terbatas_spk', '', 1, '2026-03-01 15:15:37', '2026-03-06 06:46:28'),
(133, 'NO 21 RAB', '2025-09-01', '2025-10-01', 'selesai', 'disetujui', NULL, NULL, NULL, 214008000.00, 'tender_terbatas_pkp', '', 1, '2026-03-01 15:16:54', '2026-03-06 06:46:28'),
(134, 'NO 22 RAB', '2025-11-01', '2025-12-01', 'selesai', 'disetujui', NULL, NULL, NULL, 42065000.00, 'tender_terbatas_spk', '', 1, '2026-03-01 15:18:48', '2026-03-06 06:46:28'),
(135, 'NO 23 RAB', '2025-11-01', '2025-12-01', 'selesai', 'disetujui', NULL, NULL, NULL, 42065000.00, 'tender_terbatas_spk', '', 1, '2026-03-01 15:20:37', '2026-03-06 06:46:28'),
(136, '300.XX/PB/AMGM/2025', '2025-04-01', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 9841740000.00, 'tender_umum', '', 1, '2026-03-01 15:21:50', '2026-03-06 06:46:28'),
(137, '300.XX/PB/AMGM/2025', '2025-01-01', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 42065000.00, 'tender_terbatas_spk', '', 1, '2026-03-01 15:23:41', '2026-03-06 06:46:28'),
(138, '300.XX/PB/AMGM/2025', '2025-03-01', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 42065000.00, 'tender_terbatas_spk', '', 1, '2026-03-01 15:24:57', '2026-03-06 06:46:28'),
(139, 'NO 1 JL', '2025-03-01', '2025-06-01', 'selesai', 'disetujui', NULL, NULL, NULL, 9265000000.00, 'tender_umum', '', 1, '2026-03-01 15:28:15', '2026-03-06 06:46:28'),
(140, 'NO 2 JL', '2025-04-01', '2025-05-01', 'selesai', 'disetujui', NULL, NULL, NULL, 423600000.00, 'tender_terbatas_pkp', '', 1, '2026-03-01 15:29:32', '2026-03-06 06:46:28'),
(141, 'NO 3 JL', '2025-06-01', '2025-07-01', 'selesai', 'disetujui', NULL, NULL, NULL, 423600000.00, 'tender_terbatas_pkp', '', 1, '2026-03-01 15:31:12', '2026-03-06 06:46:28'),
(142, '300.XX/PB/AMGM/2025', '2025-01-01', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 4236000000.00, 'tender_umum', '', 1, '2026-03-01 15:32:39', '2026-03-06 06:46:28'),
(143, 'NO 4 JL', '2025-01-01', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 462000000.00, 'tender_terbatas_pkp', '', 1, '2026-03-01 15:33:54', '2026-03-06 06:46:28'),
(144, 'NO 5 JL', '2025-12-01', NULL, 'selesai', 'disetujui', NULL, NULL, NULL, 462000000.00, 'tender_terbatas_pkp', '', 1, '2026-03-01 15:34:27', '2026-03-06 06:46:28'),
(145, 'NO 6 JL', '2025-12-01', '2026-01-01', 'selesai', 'disetujui', NULL, NULL, NULL, 453600000.00, 'tender_terbatas_pkp', '', 1, '2026-03-01 15:36:15', '2026-03-06 06:46:28'),
(146, 'NO 8 JL', '2025-04-01', '2025-05-01', 'selesai', 'disetujui', NULL, NULL, NULL, 458167000.00, 'tender_terbatas_pkp', '', 1, '2026-03-01 15:37:21', '2026-03-06 06:46:28'),
(147, 'NO 8 JL', '2025-06-01', '2025-07-01', 'selesai', 'disetujui', NULL, NULL, NULL, 485460000.00, 'tender_terbatas_pkp', '', 1, '2026-03-01 15:38:33', '2026-03-06 06:46:28'),
(148, 'NO 9 JL', '2025-06-01', '2025-07-01', 'selesai', 'disetujui', NULL, NULL, NULL, 213058000.00, 'tender_terbatas_pkp', '', 1, '2026-03-01 15:39:45', '2026-03-06 06:46:28'),
(149, '001/PL/AMGM/I/2026', '2026-01-05', '2026-01-07', 'selesai', 'disetujui', NULL, NULL, NULL, 4500000.00, 'pembelian_langsung', 'Kebutuhan ATK kantor pusat', 1, '2026-03-04 09:55:55', '2026-03-06 06:46:28'),
(150, '002/PL/AMGM/I/2026', '2026-01-12', '2026-01-14', 'selesai', 'disetujui', NULL, NULL, NULL, 8750000.00, 'pembelian_langsung', 'Servis rutin AC ruang server', 1, '2026-03-04 09:55:55', '2026-03-06 06:46:28'),
(151, '003/SPK/AMGM/II/2026', '2026-02-03', '2026-02-20', 'selesai', 'disetujui', NULL, NULL, NULL, 32000000.00, 'tender_terbatas_spk', 'Laptop untuk tim IT', 1, '2026-03-04 09:55:55', '2026-03-06 06:46:28'),
(152, '004/SPK/AMGM/II/2026', '2026-02-10', '2026-03-05', 'selesai', 'disetujui', NULL, NULL, NULL, 47500000.00, 'tender_terbatas_spk', 'Pengecatan ulang gedung administrasi', 1, '2026-03-04 09:55:55', '2026-03-06 06:46:28'),
(153, '005/PKP/AMGM/III/2026', '2026-03-01', '2026-04-15', 'proses', 'disetujui', NULL, NULL, NULL, 185000000.00, 'tender_terbatas_pkp', 'Pemasangan CCTV 32 titik', 1, '2026-03-04 09:55:55', '2026-03-06 06:46:28'),
(154, '006/PKP/AMGM/III/2026', '2026-03-15', NULL, 'proses', 'disetujui', NULL, NULL, NULL, 320000000.00, 'tender_terbatas_pkp', 'Upgrade jaringan fiber optic', 1, '2026-03-04 09:55:55', '2026-03-06 06:46:28'),
(155, '007/PKP/AMGM/IV/2026', '2026-04-01', NULL, 'proses', 'disetujui', NULL, NULL, NULL, 580000000.00, 'tender_terbatas_pkp', 'Pengadaan genset 100 KVA', 1, '2026-03-04 09:55:55', '2026-03-06 06:46:28'),
(156, '008/TU/AMGM/IV/2026', '2026-04-10', NULL, 'proses', 'disetujui', NULL, NULL, NULL, 950000000.00, 'tender_umum', 'Renovasi total laboratorium kualitas', 1, '2026-03-04 09:55:55', '2026-03-06 06:46:28'),
(157, '009/TU/AMGM/V/2026', '2026-05-02', NULL, 'proses', 'disetujui', NULL, NULL, NULL, 1250000000.00, 'tender_umum', 'Pengadaan 3 unit kendaraan operasional', 1, '2026-03-04 09:55:55', '2026-03-06 06:46:28'),
(158, '010/SW/AMGM/V/2026', '2026-05-15', NULL, 'proses', 'disetujui', NULL, NULL, NULL, 300000000.00, 'swakelola', 'Penataan taman dan kebun kantor', 1, '2026-03-04 09:55:55', '2026-03-06 06:46:28'),
(159, '001/PL/AMGM/I/2026', '2026-01-05', '2026-01-07', 'selesai', 'disetujui', NULL, NULL, NULL, 4500000.00, 'pembelian_langsung', 'Kebutuhan ATK kantor pusat', 1, '2026-03-04 09:56:34', '2026-03-06 06:46:28'),
(160, '002/PL/AMGM/I/2026', '2026-01-12', '2026-01-14', 'selesai', 'disetujui', NULL, NULL, NULL, 8750000.00, 'pembelian_langsung', 'Servis rutin AC ruang server', 1, '2026-03-04 09:56:34', '2026-03-06 06:46:28'),
(161, '003/SPK/AMGM/II/2026', '2026-02-03', '2026-02-20', 'selesai', 'disetujui', NULL, NULL, NULL, 32000000.00, 'tender_terbatas_spk', 'Laptop untuk tim IT', 1, '2026-03-04 09:56:34', '2026-03-06 06:46:28'),
(162, '004/SPK/AMGM/II/2026', '2026-02-10', '2026-03-05', 'selesai', 'disetujui', NULL, NULL, NULL, 47500000.00, 'tender_terbatas_spk', 'Pengecatan ulang gedung administrasi', 1, '2026-03-04 09:56:34', '2026-03-06 06:46:28'),
(163, '005/PKP/AMGM/III/2026', '2026-03-01', '2026-04-15', 'proses', 'disetujui', NULL, NULL, NULL, 185000000.00, 'tender_terbatas_pkp', 'Pemasangan CCTV 32 titik', 1, '2026-03-04 09:56:34', '2026-03-06 06:46:28'),
(164, '006/PKP/AMGM/III/2026', '2026-03-15', NULL, 'proses', 'disetujui', NULL, NULL, NULL, 320000000.00, 'tender_terbatas_pkp', 'Upgrade jaringan fiber optic', 1, '2026-03-04 09:56:34', '2026-03-06 06:46:28'),
(165, '007/PKP/AMGM/IV/2026', '2026-04-01', NULL, 'proses', 'disetujui', NULL, NULL, NULL, 580000000.00, 'tender_terbatas_pkp', 'Pengadaan genset 100 KVA', 1, '2026-03-04 09:56:34', '2026-03-06 06:46:28'),
(166, '008/TU/AMGM/IV/2026', '2026-04-10', NULL, 'proses', 'disetujui', NULL, NULL, NULL, 950000000.00, 'tender_umum', 'Renovasi total laboratorium kualitas', 1, '2026-03-04 09:56:34', '2026-03-06 06:46:28'),
(167, '009/TU/AMGM/V/2026', '2026-05-02', NULL, 'proses', 'disetujui', NULL, NULL, NULL, 1250000000.00, 'tender_umum', 'Pengadaan 3 unit kendaraan operasional', 1, '2026-03-04 09:56:34', '2026-03-06 06:46:28'),
(168, '010/SW/AMGM/V/2026', '2026-05-15', NULL, 'proses', 'disetujui', NULL, NULL, NULL, 75000000.00, 'swakelola', 'Penataan taman dan kebun kantor', 1, '2026-03-04 09:56:34', '2026-03-06 06:46:28'),
(169, '001/PL/AMGM/I/2026', '2026-01-05', '2026-01-07', 'selesai', 'disetujui', NULL, NULL, NULL, 4500000.00, 'pembelian_langsung', 'Kebutuhan ATK kantor pusat', 1, '2026-03-04 09:56:50', '2026-03-06 06:46:28'),
(170, '002/PL/AMGM/I/2026', '2026-01-12', '2026-01-14', 'selesai', 'disetujui', NULL, NULL, NULL, 8750000.00, 'pembelian_langsung', 'Servis rutin AC ruang server', 1, '2026-03-04 09:56:50', '2026-03-06 06:46:28'),
(171, '003/SPK/AMGM/II/2026', '2026-02-03', '2026-02-20', 'selesai', 'disetujui', NULL, NULL, NULL, 32000000.00, 'tender_terbatas_spk', 'Laptop untuk tim IT', 1, '2026-03-04 09:56:50', '2026-03-06 06:46:28'),
(172, '004/SPK/AMGM/II/2026', '2026-02-10', '2026-03-05', 'selesai', 'disetujui', NULL, NULL, NULL, 47500000.00, 'tender_terbatas_spk', 'Pengecatan ulang gedung administrasi', 1, '2026-03-04 09:56:50', '2026-03-06 06:46:28'),
(173, '005/PKP/AMGM/III/2026', '2026-03-01', '2026-04-15', 'proses', 'disetujui', NULL, NULL, NULL, 185000000.00, 'tender_terbatas_pkp', 'Pemasangan CCTV 32 titik', 1, '2026-03-04 09:56:50', '2026-03-06 06:46:28'),
(174, '006/PKP/AMGM/III/2026', '2026-03-15', NULL, 'proses', 'disetujui', NULL, NULL, NULL, 320000000.00, 'tender_terbatas_pkp', 'Upgrade jaringan fiber optic', 1, '2026-03-04 09:56:50', '2026-03-06 06:46:28'),
(175, '007/PKP/AMGM/IV/2026', '2026-04-01', NULL, 'proses', 'disetujui', NULL, NULL, NULL, 580000000.00, 'tender_terbatas_pkp', 'Pengadaan genset 100 KVA', 1, '2026-03-04 09:56:50', '2026-03-06 06:46:28'),
(176, '008/TU/AMGM/IV/2026', '2026-04-10', NULL, 'proses', 'disetujui', NULL, NULL, NULL, 950000000.00, 'tender_umum', 'Renovasi total laboratorium kualitas', 1, '2026-03-04 09:56:50', '2026-03-06 06:46:28'),
(177, '009/TU/AMGM/V/2026', '2026-05-02', NULL, 'proses', 'disetujui', NULL, NULL, NULL, 1250000000.00, 'tender_umum', 'Pengadaan 3 unit kendaraan operasional', 1, '2026-03-04 09:56:50', '2026-03-06 06:46:28'),
(178, '010/SW/AMGM/V/2026', '2026-05-15', NULL, 'proses', 'disetujui', NULL, NULL, NULL, 75000000.00, 'swakelola', 'Penataan taman dan kebun kantor', 1, '2026-03-04 09:56:50', '2026-03-06 06:46:28'),
(179, '001/PL/AMGM/I/2026', '2026-01-05', '2026-01-07', 'selesai', 'disetujui', NULL, NULL, NULL, 4500000.00, 'pembelian_langsung', 'Kebutuhan ATK kantor pusat', 1, '2026-03-04 10:00:41', '2026-03-06 06:46:28'),
(180, '002/PL/AMGM/I/2026', '2026-01-12', '2026-01-14', 'selesai', 'disetujui', NULL, NULL, NULL, 8750000.00, 'pembelian_langsung', 'Servis rutin AC ruang server', 1, '2026-03-04 10:00:41', '2026-03-06 06:46:28'),
(181, '003/SPK/AMGM/II/2026', '2026-02-03', '2026-02-20', 'selesai', 'disetujui', NULL, NULL, NULL, 32000000.00, 'tender_terbatas_spk', 'Laptop untuk tim IT', 1, '2026-03-04 10:00:41', '2026-03-06 06:46:28'),
(182, '004/SPK/AMGM/II/2026', '2026-02-10', '2026-03-05', 'selesai', 'disetujui', NULL, NULL, NULL, 47500000.00, 'tender_terbatas_spk', 'Pengecatan ulang gedung administrasi', 1, '2026-03-04 10:00:41', '2026-03-06 06:46:28'),
(183, '005/PKP/AMGM/III/2026', '2026-03-01', '2026-04-15', 'proses', 'disetujui', NULL, NULL, NULL, 185000000.00, 'tender_terbatas_pkp', 'Pemasangan CCTV 32 titik', 1, '2026-03-04 10:00:41', '2026-03-06 06:46:28'),
(184, '006/PKP/AMGM/III/2026', '2026-03-15', NULL, 'proses', 'disetujui', NULL, NULL, NULL, 320000000.00, 'tender_terbatas_pkp', 'Upgrade jaringan fiber optic', 1, '2026-03-04 10:00:41', '2026-03-06 06:46:28'),
(185, '007/PKP/AMGM/IV/2026', '2026-04-01', NULL, 'proses', 'disetujui', NULL, NULL, NULL, 580000000.00, 'tender_terbatas_pkp', 'Pengadaan genset 100 KVA', 1, '2026-03-04 10:00:41', '2026-03-06 06:46:28'),
(186, '008/TU/AMGM/IV/2026', '2026-04-10', NULL, 'proses', 'disetujui', NULL, NULL, NULL, 950000000.00, 'tender_umum', 'Renovasi total laboratorium kualitas', 1, '2026-03-04 10:00:41', '2026-03-06 06:46:28'),
(187, '009/TU/AMGM/V/2026', '2026-05-02', NULL, 'proses', 'disetujui', NULL, NULL, NULL, 1250000000.00, 'tender_umum', 'Pengadaan 3 unit kendaraan operasional', 1, '2026-03-04 10:00:41', '2026-03-06 06:46:28'),
(188, '010/SW/AMGM/V/2026', '2026-05-15', NULL, 'proses', 'disetujui', NULL, NULL, NULL, 75000000.00, 'swakelola', 'Penataan taman dan kebun kantor', 1, '2026-03-04 10:00:41', '2026-03-06 06:46:28');

-- --------------------------------------------------------

--
-- Struktur dari tabel `realisasi_vendor`
--
...
--
-- Dumping data untuk tabel `realisasi_vendor`
--

INSERT INTO `realisasi_vendor` (`id`, `realisasi_id`, `nama_vendor`, `nomor_kontrak`, `tanggal_kontrak`, `nilai_kontrak`, `created_at`) VALUES
(1, 149, 'UD Sumber Makmur', '001/PL/AMGM/I/2026', '2026-01-05', 4500000.00, '2026-03-04 10:00:42'),
(2, 150, 'CV Sejuk Abadi', '002/PL/AMGM/I/2026', '2026-01-12', 8750000.00, '2026-03-04 10:00:42'),
(3, 151, 'PT Mitra Teknologi Utama', '003/SPK/AMGM/II/2026', '2026-02-03', 30000000.00, '2026-03-04 10:00:42'),
(4, 151, 'CV Solusi Digital', '003A/SPK/AMGM/II/2026', '2026-02-03', 2000000.00, '2026-03-04 10:00:42'),
(5, 152, 'UD Cat Jaya', '004/SPK/AMGM/II/2026', '2026-02-10', 21100000.00, '2026-03-04 10:00:42'),
(6, 152, 'CV Karya Indah', '004A/SPK/AMGM/II/2026', '2026-02-10', 26400000.00, '2026-03-04 10:00:42'),
(7, 153, 'PT Securindo Pratama', '005/PKP/AMGM/III/2026', '2026-03-01', 185000000.00, '2026-03-04 10:00:42'),
(8, 154, 'PT Jaringan Nusantara', '006/PKP/AMGM/III/2026', '2026-03-15', 320000000.00, '2026-03-04 10:00:42'),
(9, 155, 'PT Power Systems Indonesia', '007/PKP/AMGM/IV/2026', '2026-04-01', 520000000.00, '2026-03-04 10:00:42'),
(10, 155, 'CV Elektrika Mandiri', '007A/PKP/AMGM/IV/2026', '2026-04-01', 60000000.00, '2026-03-04 10:00:42'),
(11, 156, 'PT Bangun Cipta Persada', '008/TU/AMGM/IV/2026', '2026-04-10', 950000000.00, '2026-03-04 10:00:42'),
(12, 157, 'PT Krama Yudha Tiga Berlian Motors', '009/TU/AMGM/V/2026', '2026-05-02', 1250000000.00, '2026-03-04 10:00:42');
...
CREATE TABLE `users` (
  ...
  `role` enum('admin','manajer_pengadaan','staf_pengadaan') NOT NULL DEFAULT 'staf_pengadaan',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 'admin', '$2y$10$jNn3dsvAzkQwyeYbceCE7Og5G85nL9jIpSBPhnkwi5ZKZZmZxS3hi', 'Server Manajer', 'admin', '2026-02-20 12:08:17'),
(7, 'manajer', '$2y$10$ysJtbSBN0Ms.0.TxjB3yIe/bVepry8awEhBU66v37wekOozfQNZ1m', 'Eko Daeng W', 'manajer_pengadaan', '2026-03-09 08:58:18'),
(8, 'staf1', '$2y$10$0RbGWypSyVujbM9g.njJTO4mM2/3AIJ0f04g7NBUrrPXhFwDlSIPy', 'Fitri Anjani', 'staf_pengadaan', '2026-03-09 08:59:30');
...
ALTER TABLE `notifikasi`
  ...
  ADD KEY `idx_role` (`untuk_role`),
  ADD KEY `idx_user` (`untuk_user_id`),
...
ALTER TABLE `realisasi_kegiatan`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_status_verif` (`status_verifikasi`),
  ADD KEY `idx_created_by` (`created_by`);

--
-- Indeks untuk tabel `realisasi_vendor`
--
ALTER TABLE `realisasi_vendor`
  ADD PRIMARY KEY (`id`),
  ADD KEY `realisasi_id` (`realisasi_id`);
...
--
-- AUTO_INCREMENT untuk tabel `realisasi_vendor`
--
ALTER TABLE `realisasi_vendor`
...
--
ALTER TABLE `notifikasi`
  ADD CONSTRAINT `notifikasi_ibfk_1` FOREIGN KEY (`realisasi_id`) REFERENCES `realisasi_kegiatan` (`id`) ON DELETE CASCADE;
...
--
-- Ketidakleluasaan untuk tabel `realisasi_vendor`
--
ALTER TABLE `realisasi_vendor`
  ADD CONSTRAINT `realisasi_vendor_ibfk_1` FOREIGN KEY (`realisasi_id`) REFERENCES `realisasi_kegiatan` (`id`) ON DELETE CASCADE;
